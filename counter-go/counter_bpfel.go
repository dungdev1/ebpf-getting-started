...
type counterProgramSpecs struct {
	XdpXcounter *ebpf.ProgramSpec `ebpf:"xdp_xcounter"`
}
...
type counterMapSpecs struct {
	XcounterMap *ebpf.MapSpec `ebpf:"xcounter_map"`
}
...
type counterMaps struct {
	XcounterMap *ebpf.Map `ebpf:"xcounter_map"`
}
...
type counterPrograms struct {
	XdpXcounter *ebpf.Program `ebpf:"xdp_xcounter"`
}
